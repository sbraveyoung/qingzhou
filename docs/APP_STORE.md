...
| Bundle ID | `com.sbraveyoung.vpn.ios` | 不改,已配 entitlement |
...
| 支持 URL | `https://github.com/sbraveyoung/vpn/issues` | **提交前确保 repo 是 public 状态**,否则审核打不开 |
...
```
节点,订阅,网络,配置,trojan,vmess,vless,xray,clash,shadowsocks,proxy tool,network utility
```
...
特性
• 多协议支持: trojan / vmess / vless / shadowsocks
• 订阅自动刷新,自定义刷新周期
• 节点并发延迟测速,一键择优
• 规则模式: 中国域名直连、海外走代理,可自定义
...
• 详见隐私政策: https://sbraveyoung.github.io/vpn/privacy
